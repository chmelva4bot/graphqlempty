...
class ChatScreenIntegrationTestAvatarPlaceholder {
...
//        Dispatchers.setMain(UnconfinedTestDispatcher())
        ...
        user = cz.applifting.graphqlempty.firebasechat.auth.BasicUser("uid1", "user1", null)
    ...
    @Test
    fun testAvatarPlaceholderVisible() {
        ...
        composeRule.onNodeWithContentDescription("User avatar").assertDoesNotExist()
        composeRule.onNodeWithContentDescription("User avatar placeholder").assertExists()
