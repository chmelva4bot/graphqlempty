...
sealed class ChatEvent: cz.applifting.graphqlempty.Event {
    ...
    data class SetUser(val user: cz.applifting.graphqlempty.firebasechat.auth.BasicUser): ChatEvent()
...
data class ChatState(
    ...
    val isError: Boolean,
    val user: cz.applifting.graphqlempty.firebasechat.auth.BasicUser?,
